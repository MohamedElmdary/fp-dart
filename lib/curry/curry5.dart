...
CurryFn<P5, CurryFn<P4, CurryFn<P3, CurryFn<P2, CurryFn<P1, R>>>>> curry5R<P1, P2, P3, P4, P5, R>(R Function(P1, P2, P3, P4, P5) fn) {
  CurryFn<P4, CurryFn<P3, CurryFn<P2, CurryFn<P1, R>>>> next(P5 p5) {
